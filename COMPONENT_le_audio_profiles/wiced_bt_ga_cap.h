...
typedef struct
{
    ...
    uint8_t is_disconnecting;                        /**< DO NOT SET IN APP. Used by profile internally */
...
wiced_result_t wiced_bt_cap_utils_create_cis(uint16_t conn_id, wiced_bt_ga_ascs_ase_t *p_ase_data);
